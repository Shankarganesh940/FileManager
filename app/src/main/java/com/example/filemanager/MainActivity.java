...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String[] spnAction={"Select","Cut", "Copy", "Paste", "Rename", "Delete","New Folder"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            dirPath = String.valueOf(android.os.Environment.getExternalStorageDirectory().getPath()+"/ScribeForMe/");
        }
        ...
        lst_Folder.setOnItemLongClickListener(new android.widget.AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(intSelected.contains(i)){
                    ...
                    intSelected.add(i);
                    lst_Folder.getChildAt(i).setBackgroundColor(Color.LTGRAY);
                }
        ...
        try{
            ...
            for (int i = 0; i < filelist.length; i++) {
                ...
                if(filelist[i].isDirectory()==true){
                    intImages.add(R.drawable.ic_folder);
                }else if(filelist[i].isFile()==true){
                    intImages.add(R.drawable.ic_audiotrack_black_24dp);
                }else{
                    intImages.add(R.drawable.ic_audiotrack_black_24dp);
                }
            }
...
//  intCutORCopy=0; //0=Nothing, 1=Cut, 2=Copy REFERENCE
    ...
    public void NewFolder(){
        try{
            ...
            dialogBuilder.setTitle("Scribe4Me");
            dialogBuilder.setMessage("Create New Folder");
